  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center h-40 w-full">
        <div className="z-20" ref={searchInputRef}>
          ...
          <div>
            {showSearchList && (
              <div className="w-120 relative ">
                <ul className="max-h-60 w-120 border border-t-0 leading-8 overflow-auto absolute z-10 bg-white">
                  {searchList.map(({ commonName }, idx) => (
                    <li
                      key={idx}
                      onClick={e => onInsertInputValue(e)}
      ...
      <div className="max-h-40 flex flex-col justify-center items-center"></div>
    </>
  );
}
